/** SECTION: Auth slice — login, register, session restore, and profile updates */
...
// ─── Async thunks (API calls + persist token/user) ───
...
// ─── Slice: state shape + sync reducers + async lifecycle handlers ───
